...
<div class="page-header">
        <h1>Administrare - Log Level</h1>
		<p>Pe aceast&#259; pagin&#259; pute&#355;i urm&#259;ri ultimele 10 activit&#259;&#355;i de de nivel.</p>
      </div>
<div class="well">
...
<?PHP
 if(isset($_SESSION['user_admin']) && checkInt($_SESSION['user_admin']) && $_SESSION['user_admin']>=0) {
	...
	$ergebnis = mysqli_query($sqlServ, "SELECT name,level,playtime,time from log.levellog ORDER BY time DESC LIMIT ".$test[1].",".$serverSettings['page_entries']);
	...
	if($i<=50) {
      ...
      echo'<a href="index.php?page=admin&a=levellog&p='.$i.'">';
...
<td><input class="form-control input-lg" placeholder="IP-ul jucătorului…" name="name" type="text" id="name"></td>
</tr>
<tr>
<td width="50"> </td>
<td> </td>
