...
<div class="page-header">
        <h1>Administrare - Log Hack</h1>
		<p>Pe aceast&#259; pagin&#259; pute&#355;i urm&#259;ri ultimele 10 activit&#259;&#355;i de Hack.</p>
      </div>
<div class="well">
<table class="table table-striped">
            ...
            <tbody>
<?PHP
	$sqlCmd = "SELECT COUNT(*) AS cnt FROM log.hack_log LIMIT 100";
	...
	$ergebnis = mysqli_query($sqlServ, "SELECT name,login,ip,server,why,time from log.hack_log ORDER BY time DESC LIMIT ".$test[1].",".$serverSettings['page_entries']);
	...
	if($i<=50) {
      ...
      echo'<a href="index.php?page=admin&a=hacklog&p='.$i.'">';
