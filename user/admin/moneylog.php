...
<div class="page-header">
        <h1>Administrare - Log Yang</h1>
		<p>Pe aceast&#259; pagin&#259; pute&#355;i urm&#259;ri ultimele 10 activit&#259;&#355;i cu yang.</p>
      </div>
<div class="well">
...
<?PHP
 if(isset($_SESSION['user_admin']) && checkInt($_SESSION['user_admin']) && $_SESSION['user_admin']>=0) {
	...
	$ergebnis = mysqli_query($sqlServ, "SELECT vnum,type,gold,time from log.money_log ORDER BY time DESC LIMIT ".$test[1].",".$serverSettings['page_entries']);
...
<td><input class="form-control input-lg" placeholder="IP-ul jucătorului…" name="vnum" type="text" id="vnum"></td>
</tr>
<tr>
<td width="50"> </td>
<td> </td>
